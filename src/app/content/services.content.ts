export const contenidoSeccionServicios = {
  ...
  servicios: [
    ...
    {
      titulo: 'Eventos y mayoreo',
      distintivo: 'Cotización flexible',
      descripcion: 'Armamos pedidos para bodas, corporativos, lanzamientos y celebraciones familiares.',
      detalles: [
